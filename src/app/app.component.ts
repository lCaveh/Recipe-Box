...
export class AppComponent {
  ...
  recipes: Recipe[] = [
    new Recipe('Simple White Cake',['1 cup white sugar','1/2 cup butter','2 eggs','2 teaspoons vanilla extract','1 1/2 cups all-purpose flour','1 3/4 teaspoons baking powder','1/2 cup milk'],`Preheat oven to 350 degrees F (175 degrees C). Grease and flour a 9x9 inch pan or line a muffin pan with paper liners.
